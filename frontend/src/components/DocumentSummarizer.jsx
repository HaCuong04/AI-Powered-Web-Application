...
// ─── Icons ───────────────────────────────────────────────────────────────────
const UploadIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{color: '#7e57c2', marginBottom: '10px'}}><polyline points="16 16 12 12 8 16"></polyline><line x1="12" y1="12" x2="12" y2="21"></line><path d="M20.39 18.39A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.3"></path><polyline points="16 16 12 12 8 16"></polyline></svg>
);

const FileIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{marginRight: '10px', minWidth: '24px'}}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
);
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: '#f7f8fa', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ width: '280px', background: '#fff', borderRight: '1px solid #ebedf0', padding: '24px', display: 'flex', flexDirection: 'column' }}>
        ...
        <h2 style={{ color: '#8c8c8c', fontSize: '13px', textTransform: 'uppercase', marginBottom: '16px', letterSpacing: '0.05em' }}>Recent Summaries</h2>
        ...
        <div style={{ 
          ...
          {!file ? (
            ...
            <>
                ...
                {/* RATE LIMIT BANNER */}
                {sessionId && rateLimit && (
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px', padding: '10px 14px', background: rateLimit.remaining === 0 ? '#fff0f0' : '#f8f9fa', border: `1px solid ${rateLimit.remaining === 0 ? '#ffd6d6' : '#ebedf0'}`, borderRadius: '8px', fontSize: '13px' }}>
                    <span style={{ color: '#5c5c5c', fontWeight: '500' }}>Session Quota ({rateLimit.window}s window)</span>
